...
public class CompensationPaymentController {
        ...
        @PostMapping("/from-ap")
        public ResponseEntity<CompensationPaymentResponseDTO> createWithAP(
                        @RequestBody CompensationPaymentAPRequestDTO request) {

                CompensationPaymentResponseDTO response = compensationPaymentService
                                .registerCompensationPaymentWithAP(request);
